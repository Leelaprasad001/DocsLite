    ...
    <>
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="relative max-w-6xl w-full h-[180px] md:h-[600px] mt-16 rounded-lg overflow-hidden">
            <Image
        ...
        <div id="children" className="flex flex-col-reverse md:flex-row justify-between items-center">
          <div className="max-w-xl">
            <h1 className="text-xl md:text-4xl font-semibold mb-2 text-blue-100">Start Collaborating with DocsLite</h1>
            ...
            <div className="mt-6">
              <ul className="list-none ml-2">
                {features.map((feature, index) => (
                  <li key={index} className="flex items-center mb-2 text-sm md:text-md">
